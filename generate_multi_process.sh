#! /bin/zsh
output_dir=./your_data_dir/
# Please adjust the number of processes and MKL_NUM_THREADS so that their product matches the number of logical cores.
MKL_NUM_THREADS=5 python3 ./generate_audio.py --workid=0 --savedir=$output_dir --n_iter=2500 --seed=0&
MKL_NUM_THREADS=5 python3 ./generate_audio.py --workid=1 --savedir=$output_dir --n_iter=2500 --seed=1&
