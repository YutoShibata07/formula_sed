...
boundaries_global_f0_mel_variance = [30**0.5, 30**1.0, 30**1.5]
boundaries_global_f0_mel_initial_bias = [50**1.25, 50**1.5, 50**1.75]
boundaries_global_harmonic_envelope_variance = [10**-0.5, 10**0.0, 10**0.5]

boundaries_global_harmonic_envelope_lengthscale = [10**1.5, 10**2.0, 10**2.5]
boundaries_global_harmonic_envelope_initial_bias = [10**-0.5, 10**0.0, 10**0.5]
boundaries_global_harmonic_envelope_center = "Not use"

boundaries_harmonic_envelope_kernel_name = boundaries_of_kernels
boundaries_global_noise_distribution_initial_bias = [10**-0.5, 10**0.0, 10**0.5]
boundaries_global_noise_distribution_mode = np.linspace(10, 90, 9)

boundaries_kernel_freq_name = boundaries_of_kernels
boundaries_hn_cor = [0.0]
...
boundaries_local_f0_mel_lengthscale = [10**-0.5, 10**0.0, 10**0.5]
