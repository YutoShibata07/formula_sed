...
kernels_list = [
    ...
    ],  # variance, lengthscale, period=6.283185307179586, n_freq=10, lower=0.0, upper=12.566370614359172
]
...
def kernel_sampler(rng=None, variance=None, lengthscale=None, period=None):
    kernels = [
        ...
        [
            "Exponential",
            GPy.kern.Exponential(1, variance, lengthscale),
        ...
        [
            "Poly",
            GPy.kern.Poly(1, variance, lengthscale, bias=1.0, order=3.0),
        ],  # variance, scale, bias, order
        [
            "StdPeriodic",
            GPy.kern.StdPeriodic(1, variance, period, lengthscale),
        ],  # variance, period, lengthscale
        [
            "PeriodicExponential",
            GPy.kern.PeriodicExponential(1, variance, lengthscale, period),
